...
function Todo() {
  ...
  return (
    <>
      ...
      />
      <footer>
        Created by <a href="https://github.com/Piotr-Kuras97">Piotr Kuraś</a>
      </footer>
    </>
  );
}
